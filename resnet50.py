...
extended_resnet_model_path = "models/extended_resnet50_cifar"
...
def create_model ():
    ...
    resnet_model = ResNet50(weights=None, include_top=True, input_tensor = input_tensor)
   ...
   # for i in range(1):
    ...
    model = Model(input_tensor, resnet_model.output, name = 'resnet50')
    model.compile(
